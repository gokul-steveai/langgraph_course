...
MAX_ITERATIONS = 1  # Set the maximum number of iterations of revise (n+1)
...
res = graph.invoke(
    {
        "messages": [
            HumanMessage(
                content="Plan a 5-day trip to Japan under $1000 including flights, hotels, and transport. (in 250 words)",
            )
        ]
    }
)
